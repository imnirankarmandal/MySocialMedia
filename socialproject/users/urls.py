...
urlpatterns = [
    ...
    path('password_change/', auth_view.PasswordChangeView.as_view(template_name='users/pass_change_form.html'), name='password_change'),
    path('password_change/done/', auth_view.PasswordChangeDoneView.as_view(template_name="users/pass_change_done.html"), name='password_change_done'),
